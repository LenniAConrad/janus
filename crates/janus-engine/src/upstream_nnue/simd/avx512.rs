...
//! interface.
//!
//! This file and the sibling `avx2.rs` are together the entire `unsafe`
...
//! compiled into a given binary: this module replaces `avx2.rs` whenever
//! the build statically enables `avx512f` and `avx512bw`.
//!
